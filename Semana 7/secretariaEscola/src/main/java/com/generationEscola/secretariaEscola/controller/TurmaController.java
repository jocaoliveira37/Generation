...
import com.generationEscola.secretariaEscola.model.Turma;
import com.generationEscola.secretariaEscola.repository.TurmaRepository;
...
public class TurmaController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Turma> GetByTurma(@PathVariable long id){
